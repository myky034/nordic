...
beforeAll(async () => {
  ...
  for (const migration of ["20260917090000_countries_sources","20260918090000_documents","20260918100000_rbac"]) await db.exec(readFileSync(`../../packages/db/prisma/migrations/${migration}/migration.sql`,"utf8"));
