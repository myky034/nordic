...
beforeAll(async()=>{
 ...
 for(const name of ["20260917090000_countries_sources","20260918090000_documents","20260918100000_rbac","20260919090000_facts"]) await db.exec(readFileSync(`prisma/migrations/${name}/migration.sql`,"utf8"));
